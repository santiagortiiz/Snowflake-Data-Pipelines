...
where
	...
	and l_receiptdate < add_months(date '1995-01-01',12)
group by
	l_shipmode
order by
	l_shipmode;
...
where
	...
	and l_shipdate < add_months(date '1994-09-01',1);
...
create view revenue0 (supplier_no, total_revenue) as
	...
	where
		...
		and l_shipdate < add_months(date '1995-01-01',3)
	group by
		l_suppkey;
		...
		where
			...
			and ps_availqty > (
				...
				where
					...
					and l_shipdate < add_months(date '1993-01-01',12)
			)
	)
	and s_nationkey = n_nationkey
	and n_name = 'ALGERIA'
